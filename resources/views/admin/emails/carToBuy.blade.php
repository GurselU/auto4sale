                                        ...
                                        >
                                            ...
                                            <tr>
                                                ...
                                                ><span class="fbtxt"
                                                    ...
                                                    >
                          <!-- START preview link -->
                          Si vous ne pouvez pas lire ce mail correctement, <!-- link URL here --><a
                                ...
                                >
                                    ...
                                    <tr>
                                        ...
                                        ><!-- link URL here --><img class="hide_m w700_d"
                                                                    src="images/Sellauto-bms-desk-fr.jpg"
                                    ...
                                    <tr>
                                        ...
                                        ><!-- link URL here --><img src="images/Sellauto-bms-mob-fr.jpg"
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    ><span class="fbtxt"
                                        ...
                                        >Un formulaire vient d'être soumis voici les détails:</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<thead>
  <tr>
    <th class="tg-0pky">Nom complet</th>
    <th class="tg-0pky">{{$form->name}}</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-0pky">Marque et modèle</td>
    <td class="tg-0pky">{{$form->mark}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Kilométrage (KM)</td>
    <td class="tg-0pky">{{$form->mileage}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Année d'immatriculation</td>
    <td class="tg-0pky">{{$form->year}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Type de carburant</td>
    <td class="tg-0pky">{{$form->fuel}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Code postal</td>
    <td class="tg-0pky">{{$form->zipCode}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Numéro de téléphone</td>
    <td class="tg-0pky">{{$form->phone}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Disponibilité</td>
    <td class="tg-0pky">{{$form->available}}</td>
  </tr>
  <tr>
    <td class="tg-0pky">Message</td>
    <td class="tg-0pky">{{$form->message}}</td>
  </tr>
</tbody>
</table>
                                                                                ...
                                                                                >
                                                                                    <tr>
                                                                                        <td class="fbtxt w100p_m w288_d"
                                                                                            ...
                                                                                            bgcolor="#1F2937"
                                                                                        >
                                                                                            <a href="https://www.Sellauto.be/fr/fastlane/dealer-locator.html"
                                                                                               target="_blank" title=""
        ...
        <tr>
            ...
            >
                ...
                >
                    ...
                    Cordialement,<br>
                    <strong>L'équipe Sellauto</strong>
                            ...
                            >
                                        ...
                                        >
                                            <tr>
                                                ...
                                                ><!-- Linkedin URL here --><a target="_blank"
                                                                              ...
                                                                              data-wm-content-type="link-text"
                                                    ><img class="hauto_m"
                                                          src="https://agency.cdn01.rambla.be/343820324/Sellauto/2021_assets/social-facebook-light.png"
                                                ...
                                                <td class="" width="24" align="center" valign="middle"
                                                    ...
                                                    data-wm-section-editable="true"
                                                ><!-- linkedin URL here --><a target="_blank"
                                                                              href="https://www.linkedin.com/company/Sellauto-group-belux/"
                                                                              _label="LinkedIn"
                                                                              data-wm-content-type="link-text"
                                                    ><img class="hauto_m"
                                                          src="https://agency.cdn01.rambla.be/343820324/Sellauto/2021_assets/social-linkedin-light.png"
                                                          style="display:block;" border="0" width="24" alt="LinkedIn"
                                                        ></a></td>
                                                <!-- END linkedin -->
                                                ...
                                                ><!-- instagram URL here --><a target="_blank"
                                                                               ...
                                                                               data-wm-content-type="link-text"
                                                    ><img class="hauto_m"
                                                          src="https://agency.cdn01.rambla.be/343820324/Sellauto/2021_assets/social-instagram-light.png"
                                ...
                                <tr>
                                    ...
                                    ><span class="fbtxt"
                                        ...
                                        >Donnons priorité à la sécurité <br>
