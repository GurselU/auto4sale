        ...
        <div class="relative">
            <blockquote class="mt-10">
                <div class="mx-auto max-w-3xl text-center text-2xl font-medium leading-9 text-gray-900">
                    <p>"Sellauto made selling my car so easy! Their customer service was top-notch and they handled everything from start to finish. I highly recommend
                        <strong>Sellauto</strong> to anyone looking to sell their car quickly and hassle-free."</p>
                </div>
                <footer class="mt-8">
...
{{--                        </div>--}}
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base font-medium text-gray-900">Felix Van Der Meersch</div>
