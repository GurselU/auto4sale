        ...
        <div class="relative">
            <blockquote class="mt-10">
                <div class="mx-auto max-w-3xl text-center text-2xl font-medium leading-9 text-gray-900">
                    <p>"Sellauto is the ultimate solution for anyone looking to sell their car quickly and for a fair price. Their team was so helpful and made the entire process seamless. I would highly recommend Sellauto to anyone in the market to sell their car."</p>
                </div>
                <footer class="mt-8">
...
{{--                        </div>--}}
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base font-medium text-gray-900">Arne De Vos</div>
