        ...
        <div class="relative">
            <blockquote class="mt-10">
                <div class="mx-auto max-w-3xl text-center text-2xl font-medium leading-9 text-gray-900">
                    <p>"I was skeptical about selling my car online, but <strong>Sellauto</strong> completely exceeded my expectations. They were professional, efficient, and the process was completed within just a few days. I couldn't be happier with the outcome!"</p>
                </div>
                <footer class="mt-8">
...
{{--                        </div>--}}
                        <div class="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                            <div class="text-base font-medium text-gray-900">Sophie Peeters</div>
