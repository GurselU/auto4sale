...
class CarController extends Controller
{
    ...
    public function create()
    {
        ...
        // $emissionClasses = EmissionClass::all();
        // $gearboxes = Gearbox::all();
        // return view("admin.car.create", compact("categories", "chassis", "carOrigins", "emissionClasses", "gearboxes"));
    }
    ...
    public function store(Request $request)
    {
        ...
        $car->carOrigin_id = $request->origin;
        $car->emissionClass_id = $request->class;
        ...
        $car->save();
        // return view("admin.picture.create", compact('car'))->with("success", "Car created with success");
    ...
    public function edit($id)
    {
        ...
        return view("admin.car.edit", compact('car', 'seller', 'assets', 'drowbacks', 'categories', 'chassis'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $car->save();
        return redirect()->route("car.index")->with("success", "Car edited with success");
    }
