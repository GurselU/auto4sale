...
class PictureController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->file as $file) {
            ...
            // $file->store($request->car_id, 'public_uploads');
            // $newName = Storage::disk('public_uploads')->files('carPictures/1')[0];
            // dd($newName);
            Storage::disk('public_uploads')->putFileAs('/', $file, $file->getOriginalName());
