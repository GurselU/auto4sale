        ...
        <div class="gray-form">
            <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
                ...
                <div class="mb-3">
                    ...
                    <input id="current_password" class="form-control" type="password" placeholder="Mot de passe" name="current_password" required>
                ...
                <div class="mb-3">
                    ...
                    <input id="password_confirmation" class="form-control" type="password" placeholder="Confirmez mot de passe" name="password_confirmation" required>
