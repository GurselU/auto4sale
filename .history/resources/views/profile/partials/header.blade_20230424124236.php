        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 position-relative">
              ...
              <ul class="menu-links">
                <!-- active class -->
                <li class="{{ request()->path() == '/' ? 'active' : '' }}"><a href="{{ url('') }}">Véhicules</a></li>
                <li class="{{ request()->path() == 'dealer' ? 'active' : '' }}"><a href="{{ url('dealer') }}">Profil ?</a></li>
                <li class="{{ request()->path() == 'dealer' ? 'active' : '' }}"><a href="{{ url('dealer') }}">VMot de passe ?</a></li>
