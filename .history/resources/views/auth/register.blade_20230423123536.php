                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex col-6 justify-content-start">
                                    <div class="px-3"><input style="height: 15px; width: 15px;" type="checkbox" id='categ' name='tableIdCat[]' value="{{ $cat->id }}"></div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex col-6 justify-content-start">
                                    <div class="px-3"><input style="height: 15px; width: 15px;" type="checkbox" id='chassi' name='tableIdChassi[]' value="{{ $chassi->id }}"></div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex col-6 justify-content-start">
                                    <div class="px-3"><input style="height: 15px; width: 15px;" type="checkbox" id='origin' name='tableIdOrigin[]' value="{{ $origin->id }}"></div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex col-6 justify-content-start">
                                    <div class="px-3"><input style="height: 15px; width: 15px;" type="checkbox" id='class' name='tableIdClass[]' value="{{ $class->id }}"></div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex col-6 justify-content-start">
                                    <div class="px-3"><input style="height: 15px; width: 15px;" type="checkbox" id='gearbox' name='tableIdGearbox[]' value="{{ $gearbox->id }}"></div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex col-6 justify-content-start">
                                    <div class="px-3"><input style="height: 15px; width: 15px;" type="checkbox" id='contact' name='tableIdContact[]' value="{{ $contact->id }}"></div>
