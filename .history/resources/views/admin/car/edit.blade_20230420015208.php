        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-12">
                ...
                <form action="{{ route('seller.update', $seller->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="zipCode" class="form-label">1ère mise en circulation</label>
                            <input type="date" class="form-control" id="zipCode" name="zipCode" value="{{$seller->zipCode}}" style="height: 50px;" required>
                        </div>
                        <div class="mb-3">
                            <label for="country" class="form-label">Kilométrage</label>
                            <input type="number" class="form-control" id="country" name="country" value="{{$car->country}}" required>
                        </div>
                        <div class="mb-3">
                            <label for="power" class="form-label">Puissance (ch)</label>
                            <input type="number" class="form-control" id="power" name="power" value="{{$car->power}}" required>
