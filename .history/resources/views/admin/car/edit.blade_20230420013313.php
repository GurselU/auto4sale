                ...
                <form action="{{ route('car.update', $car->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="categorie" id="categorie">
                                ...
                                <option value="{{$categorie->id}}" {{$categorie->id == $car->categorie_id ? 'selected': ''}}>{{$cat->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="chassi" id="chassi">
                                ...
                                <option value="{{$chassi->id}}" {{$chassi->id == $car->categorie_id ? 'selected': ''}}>{{$chassi->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
