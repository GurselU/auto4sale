        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="d-flex justify-content-between p-1">
                    <div class="p-1"><i class="fa fa-check p-1"></i>{{$asset->description}}</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="d-flex justify-content-between p-1">
                    <div class="p-1"><i class="fa fa-close p-1"></i>{{$drowback->description}}</div>
                ...
                @endforeach
                <div class="gray-form">
                    <form action="{{ route('drowback.update', $car->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <div class="mb-3">
