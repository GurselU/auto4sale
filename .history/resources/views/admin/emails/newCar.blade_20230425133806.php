...
<body>
    ...
    <div style="display: flex; justify-content: end; margin-top: 30px; margin-bottom: ;"><a href="{{ route('login.with.magic.link', $magicLink) }}" class="offerBtn">Faire une offre</a></div>
