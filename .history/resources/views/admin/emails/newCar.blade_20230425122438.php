    ...
    <section>
        <div>
            ...
            <ul>
                ...
                <li> <span>Transmission</span> <strong class="text-end">{{$car->gearbox->gearbox}}</strong></li>
                <li> <span>Carburant</span> <strong class="text-end">{{$car->emissionClass->class}}</strong></li>
