...
<body>
    ...
    <section id="sectionPicture">
        <div><img style="width: 1;" src="{{asset($pictures[0]->location)}}"></div>
        <div><img src="{{asset($pictures[1]->location)}}"></div>
        <div><img src="{{asset($pictures[2]->location)}}"></div>
        <div><img src="{{asset($pictures[3]->location)}}"></div>
    </section>
