...
<body>
    <section id="sectionHeader">
        <div><a href="{{ url('') }}"><img id="logo" src="{{$message->embed('images/logo-dark.png')}}" alt="logo"> </a></div>
    ...
    <section id="sectionPicture">
        <div><img style="width: 100%;" src="{{ $message->embed($pictures[0]->location) }}"></div>
        <div><img style="width: 100%;" src="{{ $message->embed($pictures[1]->location) }}"></div>
        <div><img style="width: 100%;" src="{{ $message->embed($pictures[2]->location) }}"></div>
        <div><img style="width: 100%;" src="{{ $message->embed($pictures[3]->location) }}"></div>
    </section>
    ...
    <section>
        ...
        <div style="color: #909090;">{{$car->description}}</div>
    </section>
    <div style="display: flex; justify-content: end; margin-top: 30px; margin-bottom: 30px;"><a href="{{ route('login.with.magic.link', $magicLink) }}" class="offerBtn">Faire une offre</a></div>

    <footer>
        <div>©Copyright 2023 GRS Network srl</div>
        <div>+32491767728</div>
        <div>auto@auto4sale.be</div>
    </footer>
</body>
